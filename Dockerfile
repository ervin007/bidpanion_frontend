...
ENV NEXT_PUBLIC_AUTH_ENABLE_EMAIL_PASSWORD_AUTHENTICATION=true
ENV NEXT_PUBLIC_AUTH_ENABLE_EMAIL_VERIFICATION=false
ENV NEXT_PUBLIC_ENABLE_GITHUB_INTEGRATION=false
